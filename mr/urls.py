...
urlpatterns = [
    ...
    path('patient_details/appointment/icd10/delete/<int:pk>/', views.icd10Delete.as_view(), name='delete_icd10'),
    path('patient_details/appointment/icd10/add/', views.icd10Add, name='add_icd10'),
    path('patient_details/appointment/file/upload/', views.add_app_file, name='add_app_file'),
    ...
    path('patient_details/add_surgery/file/add', views.add_surgery_file, name='add_surgery_file'),
    ...
    path('doctor_detail/<int:pk>/', views.DoctorDetail.as_view(), name='doctor_detail'),
    ...
    path('calendar/event/delete/<int:pk>', views.EventDelete.as_view(), name='delete_event'),
